...
Microservicio en Go con Gin + GORM (Postgres), arquitectura en 4 capas: controladores, servicios, dominio (DDD) y repositorios. Autenticación prevista con Firebase.
